...
{
      int      ne = 3, nc = 1;
      int      i, imax, iprn, nmethod, flag;
      double   a, b, eta, h, eps;  
      double   f[3], f0, f1, f2;
      char    *outfile, *method, inbuf[64];
      ...
      */
      newline;
      fprintf( stderr, "     >>> Choose method <<<\n" ); 
      newline;
      fprintf( stderr, "     1 = Shooting by Newton-Rhapson Method\n"  );
      fprintf( stderr, "     2 = Shooting by Bisection Method\n"       );
      fprintf( stderr, "     3 = Shooting by System Equation Sovler\n" );
      newline;
      ...
      */
      ...
      f0 = f[0];                   //  f(0)
      f1 = f[1];                   //  f'(0)
      f2 = f[2];                   //  f''(0) after computing

      flag = 1; Write_Result( fpout, method, eta, f, 1 );
      ...
      for ( i = 0; i < imax; i++ ) {
            ...
            if ( (i+1)/iprn*iprn == i+1 )
                  Write_Result( fpout, method, eta, f, flag );
      }
 ...
 *|
 *|   Usage:     Shoot_NR( ne,a,b,h,bvp,eps,f_sys );                       
 *|
 *|   Arguments:                                                                 
 ...
 *|     bvp[i] - array of boundary value and returned initial values [i/o]
 ...
 *!============================================================================!
 */
void  Shoot_NR( int ne, double a, double b, double h, double *bvp, double eps,
                void (*f_sys)( double, double *, double * ) )
{
      ...
      */
      ...
      f0 = f[0] = bvp[0];              //  save f(0)
      f1 = f[1] = bvp[1];              //  save f'(0)
      ...
      g  = error = bvp[2] - f[1];      //  f[1] = f'(inf) after compute
 ...
 *|                                                                              
 *|   Usage:     Shoot_Bisec( ne,a,b,h,bvp,eps,f_sys );                       
 *|                                                                              
 *|   Arguments:                                                                 
 ...
 *!============================================================================!
 */
void  Shoot_Bisec( int ne, double a, double b, double h, double *bvp, double eps,
                   void (*f_sys)( double, double *, double * ) )
{
      ...
      */
      ...
      g1 = bvp[2] - f[1];              //  f[1] = f'(inf) after compute
      ...
      g2 = bvp[2] - f[1];              //  f[1] = f'(inf) after compute
 ...
 *|
 *|   Usage:     Shoot_SysEqn( ne,a,b,h,bvp,eps,f_sys );
 *|
 *|   Arguments:
 *|     ne     - number of ODE system equations [i]
 *|     a      - starting (initial) point [i]
 ...
 *!============================================================================!
 */
void  Shoot_SysEqn( int ne, double a, double b, double h, double *bvp, double eps,
                    void (*f_sys)( double, double *, double * ) )
{
